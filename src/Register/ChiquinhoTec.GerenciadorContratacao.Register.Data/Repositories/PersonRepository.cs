...
namespace ChiquinhoTec.GerenciadorContratacao.Register.Data.Repositories
{
    ...
    public class PersonRepository : BaseRepository<Person>, IPersonRepository
    {
        ...
        //     The context param.
        //
        public PersonRepository(RegisterContext context) : base(context) { }
        ...
        public Task<Person> FindPersonByCpfAsync(string value)
        {
            return _context
                    .Set<Person>()
                    .Where(x => x.Cpf.Value == value && x.IsActive)
                    .FirstOrDefaultAsync();
        }
        ...
        public Task<Person> FindPersonByEmailAsync(string value)
        {
            return _context
                    .Set<Person>()
                    .Where(x => x.Email.Value == value && x.IsActive)
                    .FirstOrDefaultAsync();
        }
        ...
        public async Task<IDictionary<Guid, Person>> FindPersonsByIdAsync(IEnumerable<Guid> userIds, CancellationToken token)
        {
            return await _context
                    ...
                    .ToDictionaryAsync(a => a.Id, cancellationToken: token);
        }
    }
}